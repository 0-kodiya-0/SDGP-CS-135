        ...
        return (
            <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
                <div className="flex justify-center items-center">
                    ...
                    <span className="ml-2 text-gray-600">Verifying backup code...</span>
                </div>
            </div>
        );
    }
                ...
                <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                        ...
                        <div>
                            ...
                            <div className="mt-1">
                                <input
                                    ...
                                    className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm text-center font-mono"
                    ...
                    <div className="mt-6">
                        <div className="flex flex-col space-y-3">
                            <button
                                type="button"
                                onClick={() => navigate('/two-factor-verify', { state: { tempToken, accountId } })}
