...
export default function UploadComponent({ onFileUploaded, onClose }: UploadComponentProps) {
  ...
  return (
    // Modal overlay container to center the modal
    <div className="fixed inset-0 flex items-center justify-center p-4 z-50">
      <div className="relative w-full max-w-md mx-auto p-6 bg-white/90 backdrop-blur-xl rounded-2xl shadow-2xl max-h-[90vh] overflow-auto flex flex-col">
        {/* Close Button */}
        <button
          onClick={onClose}
        ...
        {/* File list container with fixed max height */}
        <div className="mt-4 space-y-2 overflow-y-auto flex-grow max-h-[240px]">
