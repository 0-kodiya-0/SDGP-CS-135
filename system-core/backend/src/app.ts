...
import { router as workspaceRoutes } from './feature/workspace'; // Import workspace routes
...
app.use('/workspace', authenticateSession, workspaceRoutes); // Add workspace routes
